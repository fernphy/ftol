...
- `ftol_plastid_parts.csv`: Table of gene partitions in concatenated alignment. Columns include `gene` (gene name), `start` (gene start position, inclusive), `end` (gene end position, inclusive). `r nrow(plastid_gene_part_data) %>% scales::number(big.mark = ",")` rows.
