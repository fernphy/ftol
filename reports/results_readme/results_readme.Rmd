...
- `ftol_plastid_dated.tre`: Fern tree of life (FTOL) with divergence times estimated on `ftol_plastid.tre` using fossil calibration points. Branch lengths in millions of years before present. Newick format.

- `plastid_cache.tar.gz`: Zipped file containing the [drake](https://docs.ropensci.org/drake/) cache with all intermediate output (R data files). 
