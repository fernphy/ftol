...
phy <- readd(treepl_dating_results_single, cache = plastid_cache)
phy_multiple <- readd(treepl_dating_results_multiple, cache = plastid_cache)
...
The current species tree includes `r scales::number(n_ingroup, big.mark = ",")` tips (**Fig. 1**). 
