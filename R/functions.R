...
#' 
select_genbank_genes <- function (sanger_seqs_with_voucher_data, mpcheck_monophy) {
...
#' Collapse nodes in a tree based on support value threshold
#' 
#' Adapted from 
#' https://stackoverflow.com/questions/34403957/how-to-collapse-branches-in-a-phylogenetic-tree-by-the-label-in-their-nodes-or-l #nolint
#'
...
#'
#' @param phy List of class 'phy'; input phylogeny
#' @param tol Number: collapse nodes with BS less than this to polytomies
#'
#' @return List of class 'phy'; phylogeny with nodes collapsed
#' 
di2multi4node <- function (phy, tol = 0.5) 
	
{
	# Convert node labels to numeric
	phy$node.label <- readr::parse_number(phy$node.label)
