...
plan <- drake_plan(
  ...
  #
  # About `m = "MFP+MERGE"` (from http://www.iqtree.org/doc/Command-Reference): 
  ...
  #
  plastid_partitioned_tree = jntools::iqtree(
    plastid_alignment,
    bb = 1000, nt = 32,
    m = "MFP+MERGE",
  ...
  #
  # When writing using functions that return NULL [ie, ape::write.tree()],
  # wrap in curly brackets {} and return a hash of the input with digest::digest().
  # This is so dependencies are properly tracked when rendering `results_readme.Rmd`
